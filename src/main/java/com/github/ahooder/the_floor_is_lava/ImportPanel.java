...
public class ImportPanel extends PluginPanel
{
	public ImportPanel(Plugin plugin)
	{
		...
		title.setText("TheFloorIsLava Mode Import Panel");
		...
		JLabel info = new JLabel(htmlLabel("Clicking the Import button below will migrate all tiles marked with the Ground Marker plugin into the TheFloorIsLava Mode plugin. They will NOT be removed from the Ground Marker Plugin.", "#FFFFFF"));
